...
export function Table() {
    const [produtos, setProdutos] = useState([{ nome: 'Switch Red', estoque: 100, valorCompra: 0.7, valorVenda: 2.5 },
    ...
    return <>
        ...
        <TableBody produtos={produtos} remove={remove} edit={edit} editaEstoque={editaEstoque} botaoEstoque={botaoEstoque} />
        <button style={{ marginTop: "40px" }} onClick={showModal}>Adicionar produto</button>
      
      {
        modalStatus === true ? <ModalProduto produtos={produtos} setProdutos={setProdutos} setModalStatus={setModalStatus}/> : null
      }
    </>
}